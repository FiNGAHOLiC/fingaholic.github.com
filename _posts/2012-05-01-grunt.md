...
// タスクが書かれたファイルを格納しているパス（ここではgruntTasks）
grunt.loadTasks('gruntTasks');
{% endhighlight %}

で、肝心のタスクはsass.jsとしてgruntTasksディレクトリ以下に格納。ほとんど[takazudoさんの][sass]を<del>パク</del>参考にさせてもらいました。

[sass]: https://github.com/Takazudo/takazudo.github.com/blob/master/_blogsrc/gruntTasks/sass.js 'takazudo.github.com/_blogsrc/gruntTasks/sass.js at master ・ Takazudo/takazudo.github.com'
...
圧縮はsassコマンドの--styleオプションに付けても良かったけどjsのように別途設けた方がよさそうなのでこれまた[takazudoさんの][cssmin]を<del>パク</del>参考にさせてもらいました。ちなみにNodeベースのCSSコンプレッサーである[sqwish][sqwish]なるものが必要なのでインストールしておく。

[cssmin]: https://github.com/Takazudo/takazudo.github.com/blob/master/_blogsrc/gruntTasks/cssmin.js 'takazudo.github.com/_blogsrc/gruntTasks/cssmin.js at master ・ Takazudo/takazudo.github.com'
